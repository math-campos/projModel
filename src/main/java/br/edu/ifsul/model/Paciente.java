...
public class Paciente implements Serializable {
    ...
    @Length(max = 8, min = 8,  message = "O telefone não pode ter mais que {max} caracteres")
    @Column(name = "telefone", length = 8, nullable = true) 
    private String telefone;
    
    @Length(max = 20,  message = "O sexo não pode ter mais que {max} caracteres")
